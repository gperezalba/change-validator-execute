...
const App = {
	...
	execute: async function() {
		...
		await this.contract.methods.changeValidatorsExecute(oldValidator).send({value: 1000000000000000000, from: this.account, gas: 1000000});
	},
